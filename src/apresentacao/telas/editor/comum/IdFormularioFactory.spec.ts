import IdFormularioFactoryVue from '@/apresentacao/telas/editor/comum/IdFormularioFactory.vue';
...
} from '@/dominio/comum/IdFormularioFactory.dubles';
...
describe('IdFormularioFactory', () => {
    describe('quando recebe um título', () => {
        test('exibe o id criado', () => {
            ...
            const sut = mount(IdFormularioFactoryVue, {
